  <template lc_id="kfvOQwcbzp">
      <div lc_id="XIdGTYGNJz">
          <div lc_id="h0k0XHxqAs">
              <div class="demonstration" lc_id="3C9hoiztnz">Basic Button:</div>
              ...
              <button lc-mark type="error" lc_id="G2qIN+fEra">Error</button>
          </div>
      </div>
  </template>
  <script>
