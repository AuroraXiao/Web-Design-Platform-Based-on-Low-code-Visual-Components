  <template lc_id="pF5ZSBfZwR">
      <div lc_id="svh5gymRbT">
          <div lc_id="aklN6TcgSi">
              <div class="demonstration-element" lc_id="H9Bt++Jp23">Layout Container</div>
          ...
          <div lc_id="Lg787FEsDw">
              <div class="demonstration-element" lc_id="jlEgJZCE+i">Skeleton Screen</div>
              <el-skeleton lc-mark :rows="6" animated lc_id="4O9hfMet5s"></el-skeleton>
          </div>
          <div lc_id="D3MK6Iq3TG">
              <div class="demonstration-element" lc_id="D6xQ5qpO4B">Empty State</div>
              <el-empty lc-mark description="Details Information" lc_id="sFeXbcNwIE"></el-empty>
          </div>
          <div lc_id="tpbaaOn5XS">
              <div class="demonstration-element" lc_id="6Mnu6i7QPx">Result Notice</div>
              <el-row lc_id="FMdEXTrYSx">
                  <el-col :sm="12" :lg="6" lc_id="deKtOM/g2K">
                      <el-result icon="success" lc-mark title="Success Notices" subtitle="请根据提示进行操作" lc_id="iF6n6EUcmn">
                          <template #extra lc_id="iJQp/8XeSP">
                              <el-button type="primary" size="medium" lc_id="UCFmR9EP+q">Return</el-button>
                          </template>
                      </el-result>
                  </el-col>
                  <el-col :sm="12" :lg="6" lc_id="1smWMRRuZr">
                      <el-result icon="warning" lc-mark title="Warning Notices" subtitle="请根据提示进行操作" lc_id="NIEZCy3gG0">
                          <template #extra lc_id="c6Unj7eQIv">
                              <el-button type="primary" size="medium" lc_id="MDEtfbmEZd">Return</el-button>
                          </template>
                      </el-result>
                  </el-col>
                  <el-col :sm="12" :lg="6" lc_id="2zio5J9ljq">
                      <el-result icon="error" lc-mark title="Error Notices" subtitle="请根据提示进行操作" lc_id="kLASzKidTD">
                          <template #extra lc_id="rnIhJqKRjQ">
                              <el-button type="primary" size="medium" lc_id="MhrCBFBHlN">Return</el-button>
                          </template>
                      </el-result>
                  </el-col>
                  <el-col :sm="12" :lg="6" lc_id="h7xNXozZ0s">
                      <el-result icon="info" lc-mark title="Info Notices" subtitle="请根据提示进行操作" lc_id="aDXqAjXsST">
                          <template #extra lc_id="nHgp3LGSea">
                              <el-button type="primary" size="medium" lc_id="VURe3Zlhq0">Return</el-button>
                          </template>
                      </el-result>
                  </el-col>
              </el-row>
