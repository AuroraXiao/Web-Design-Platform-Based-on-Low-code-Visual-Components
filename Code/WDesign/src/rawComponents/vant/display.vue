  <template lc_id="Q6tpxgu3Af">
      <div lc_id="SUq1dM6mx7">
          <div lc_id="bVMFhQWWZi">
              <div class="demonstration-vant" lc_id="aksDVgfMhj">Basic Collapse</div>
              <van-collapse v-model="activeNames" lc-mark lc_id="npKi1y5bk5">
                  <van-collapse-item title="Titile1" name="1" lc_id="wlqZiTcBQn">Content</van-collapse-item>
                  <van-collapse-item title="Titile2" name="2" lc_id="lVEmjp4jgU">Content</van-collapse-item>
                  <van-collapse-item title="Titile3" name="3" disabled lc_id="LJVFOApV8X">Content</van-collapse-item>
              </van-collapse>
          </div>
          <div lc_id="C3lXrwAiNI">
              <div class="demonstration-vant" lc_id="0boIDS47ol">Multi-type CountDown</div>
          ...
          <div lc_id="+TRSEJ64CC">
              <div class="demonstration-vant" lc_id="uaaKUshda6">Multi-type Divider</div>
              <van-divider lc-mark lc_id="O+mmvHZU5g"></van-divider>
              <van-divider lc-mark lc_id="ZFHen1KfO4">text</van-divider>
              <van-divider lc-mark content-position="left" lc_id="2YAd2q9KCC">text</van-divider>
              <van-divider lc-mark content-position="right" lc_id="07IIi1+FZz">text</van-divider>
              <van-divider lc-mark :style="{ color: '#1989fa', borderColor: '#1989fa', padding: '0 16px' }" lc_id="UtOxHb5Qfg">text</van-divider>
          </div>
          <div lc_id="T6tvspYttI">
              <div class="demonstration-vant" lc_id="tQEA1/gYgR">Empty State</div>
              <van-empty image="error" lc-mark description="Details Information" lc_id="LT8YsAR9bR"></van-empty>
              <van-empty image="network" lc-mark description="Details Information" lc_id="4Y26THSVSF"></van-empty>
              <van-empty image="search" lc-mark description="Details Information" lc_id="XG4M0i9r7v"></van-empty>
          </div>
          <div lc_id="7cp54ntFq/">
              <div class="demonstration-vant" lc_id="NlDW984NIX">Basic List</div>
          ...
          <div lc_id="sl50gl586K">
              <div class="demonstration-vant" lc_id="2fzVlX0csX">Scrollable NoticeBar</div>
              <van-notice-bar left-icon="volume-o" lc-mark text="Technology is the common soul of the people who developed it." lc_id="k61bYFFVQm"></van-notice-bar>
              <van-notice-bar scrollable text="Technology is the common soul of the people who developed it." lc-mark lc_id="hVnGw6dGn5"></van-notice-bar>
              <van-notice-bar :scrollable="false" text="Technology is the common soul of the people who developed it." lc-mark lc_id="xlMfxzUiEv"></van-notice-bar>
          </div>
          <div lc_id="7E/zp4vYl5">
              <div class="demonstration-vant" lc_id="Z0VWmNgtun">Basic Progress</div>
          ...
          <div lc_id="mllWNtm7WD">
              <div class="demonstration-vant" lc_id="XU1g37b7Bj">Skeleton Screen</div>
          ...
          <div lc_id="H2zy4AGqzd">
              <div class="demonstration-vant" lc_id="f2BUM74AC2">Step Bar</div>
          ...
          <div lc_id="ag50o0J0rJ">
              <div class="demonstration-vant" lc_id="ZKGeQcO9+f">Basic Swipe</div>
